...
export BACKEND_INTERNAL_PORT=${BACKEND_INTERNAL_PORT:-8080} # Порт для Go-приложения
export FRONTEND_PORT=${PORT:-8081}             # Порт для 'serve', берется из PORT (Cloud Run) или по умолчанию 8081
